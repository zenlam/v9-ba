...
class ReportBaskinCustomerPaymentBase(models.AbstractModel):
    _name = 'report.baskin_bulk_payment.report_baskin_cust_payment_base'
    ...
    def render_html(self, data):
        ...
        return self.env['report'].render('baskin_bulk_payment.report_baskin_cust_payment_base', docargs)
