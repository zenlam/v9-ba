    ...
    def find_one_or_create_token(self, user_id=None, create=False):
        ...
        if access_token:
            ...
            if access_token.has_expired():
                access_token = None
            # Condition 1: the request is creating a token
            # Condition 2: there is an active token in the system
            # Condition 3: the token is about to expire
            # Result: Create a new token
            if create and access_token and access_token.near_expired():
                access_token = None
