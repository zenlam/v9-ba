odoo.define('br_product.FormView', function (require) {
"use strict";
...
var FormView = require('web.FormView');
    ...
    FormView.include({
                ...
                $.when.apply($, deferred).always(function () {
                    ...
                    if (form_invalid) {
                        ...
                        if (!self.datarecord.id) {
                            // Creation save
                            self.reminder_update_pricelist();
        ...
        reminder_update_pricelist: function(){
            if (this.model == 'br.menu.name.recipe') {
                alert('Please update this menu name in price list.');
            }
        }
    });
});
